...
# --- 2. 【核】MutationObserver：ブラウザの挙動を監視・上書きし続ける ---
# window.top を操作して、大元の lang 属性を強制固定します
components.html("""
    <script>
...
# --- 3. 【究極CSS】アイコンを画像へ強制置換（保護をさらに強化） ---
st.markdown("""
    <style>
    .stApp { background-color: #f8fafc; }
    font { vertical-align: inherit !important; } 

    /* ★ 矢印アイコンの文字化けを根絶する最終指定 */
    /* spanだけでなく、buttonの中にあるテキストすべてを対象にします */
    ...
    span[data-testid="stSidebarCollapseIcon"]::before {
        ...
        background-image: url('data:image/svg+xml;utf8,<svg xmlns="http://www.w3.org/2000/svg" viewBox="0 0 24 24" fill="%2364748b"><path d="M10 6L8.59 7.41 13.17 12l-4.58 4.59L10 18l6-6z"/></svg>') !important;
